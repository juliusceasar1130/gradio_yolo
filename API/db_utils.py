...
DB_CONFIG = {
    ...
    "user": "root",
    "password": "root",
    "database": "skid_management_system",
    "charset": "utf8mb4",
...
def save_detection_result(skid_number, cls_name,img_url):
    ...
    try:
        ...
        # 插入数据到skid_info表
        cursor.execute(
            "INSERT INTO skid_info (skid_id, inspection_time, clean_status, last_photo, status_change_time, created_at, updated_at, online_status, remarks) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
            (skid_number, current_time, cls_name, img_url, current_time, current_time, current_time, "online", "自动检测")
        )
