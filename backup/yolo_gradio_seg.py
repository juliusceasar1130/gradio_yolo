...
# 加载YOLO模型###############################################
model_path = r"D:\00deeplearn\yolo11\【2】训练模型\seg\train2_new\weights\best.pt"
...
def detect_objects(image, conf_threshold=0.25):
    ...
    # 使用YOLO模型检测对象
    #show_boxes=True
    results = yolo_model.predict(source=image, conf=conf_threshold,retina_masks=True,show_boxes=False)
